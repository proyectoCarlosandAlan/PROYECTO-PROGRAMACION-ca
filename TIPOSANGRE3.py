...
def registrar_donante_gui():
    ...
    if donante["edad"] < 18:
        motivos_no_disponible.append("Menor de 18 años")
    if donante["enfermedades"] == "si":
        motivos_no_disponible.append("Tiene una enfermedad que impide donar")
    if donante["tatuajes"] == "si":
        motivos_no_disponible.append("Tatuajes o perforaciones en el último año")
    if donante["medicamentos"] == "si":
        motivos_no_disponible.append("Tomó medicamentos en las últimas 48 horas")
    if donante["disponible"] == "no":
        motivos_no_disponible.append("Donante no disponible según selección")

    if motivos_no_disponible:
        donante["disponible"] = "no"
        estado = "No disponible para donar:\n- " + "\n- ".join(motivos_no_disponible)
    else:
        estado = "Disponible para donar: no se detectaron impedimentos registrados."
...
label_tatuajes = tk.Label(scrollable_frame, text="¿Tiene tatuajes o perforaciones en el último año?:", bg="#e6f7ff", fg="#003366", font=("Arial", 11))
...
label_medicamentos = tk.Label(scrollable_frame, text="¿Tomó medicamentos en las últimas 48 horas?:", bg="#e6f7ff", fg="#003366", font=("Arial", 11))
